...
runtime for composable meta-distributions. pure mechanism: no fuse, no path
rewriting, no per-distro branching. layers are composed from a content-addressed
